...
<body>
    ...
    <?php
        if (isset($_POST["Andhadhun"])) {
            $mov="Andhadhun";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        }
        elseif (isset($_POST["Goodfellas"])) {
            $mov="Goodfellas";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        }
        elseif (isset($_POST["Isawthedevil"])) {
            $mov="I Saw The Devil";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        }
        elseif (isset($_POST["Memories_of_Murder"])) {
            $mov="Memories of Murder";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        };
    ?>
    <br>
            <body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <input class="seat" name="seats[]" value="CCF1"  type="checkbox">
                        <input class="seat" name="seats[]" value="CCF2"  type="checkbox">
                        <input class="seat" name="seats[]" value="CCF3"  type="checkbox">
                    </div>
                    <div class="row">
                        <input class="seat" name="seats[]" value="CCM1"  type="checkbox">
                        <input class="seat" name="seats[]" value="CCM2"  type="checkbox">
                        <input class="seat" name="seats[]" value="CCM3"  type="checkbox">
                    </div>
                    <div class="row">
                        <input class="seat" name="seats[]" value="CCB1"  type="checkbox">
                        <input class="seat" name="seats[]" value="CCB2"  type="checkbox">
                        <input class="seat" name="seats[]" value="CCB3"  type="checkbox">
                    </div>
                </div>
