...
<body>
    ...
    <?php
        ...
        elseif (isset($_POST["The_Thing"])) {
            $mov="The Thing";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        }
        elseif (isset($_POST["The_Shining"])) {
            $mov="The Shining";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        }
        elseif (isset($_POST["Tumbbad"])) {
            $mov="Tumbbad";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        };
    ...
    <br>
            ...
            <br><h1>Horror House</h1>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <input class="seat" name="seats[]" value="HHF1"  type="checkbox">
                        <input class="seat" name="seats[]" value="HHF2"  type="checkbox">
                        <input class="seat" name="seats[]" value="HHF3"  type="checkbox">
                    </div>
                    <div class="row">
                        <input class="seat" name="seats[]" value="HHM1"  type="checkbox">
                        <input class="seat" name="seats[]" value="HHM2"  type="checkbox">
                        <input class="seat" name="seats[]" value="HHM3"  type="checkbox">
                    </div>
                    <div class="row">
                        <input class="seat" name="seats[]" value="HHB1"  type="checkbox">
                        <input class="seat" name="seats[]" value="HHB2"  type="checkbox">
                        <input class="seat" name="seats[]" value="HHB3"  type="checkbox">
                    </div>
                </div>
