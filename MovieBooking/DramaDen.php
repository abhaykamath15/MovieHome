...
<body>
    ...
    <?php
        if (isset($_POST["3_Idiots"])) {
            $mov="3 Idiots";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        }
        elseif (isset($_POST["Parasite"])) {
            $mov="Parasite";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        }
        elseif (isset($_POST["BTTF"])) {
            $mov="Back To The Future";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        }
        elseif (isset($_POST["Shoplifters"])) {
            $mov="Shoplifters";
            $sql = "INSERT INTO Ticket(Name,Email,Phone,Title) VALUES (NULL, NULL, NULL, '$mov')";
            $result = mysqli_query($conn,$sql);
        };
    ...
    <br>
            <body>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <input class="seat" name="seats[]" value="DDF1"  type="checkbox">
                        <input class="seat" name="seats[]" value="DDF2"  type="checkbox">
                        <input class="seat" name="seats[]" value="DDF3"  type="checkbox">
                    </div>
                    <div class="row">
                        <input class="seat" name="seats[]" value="DDM1"  type="checkbox">
                        <input class="seat" name="seats[]" value="DDM2"  type="checkbox">
                        <input class="seat" name="seats[]" value="DDM3"  type="checkbox">
                    </div>
                    <div class="row">
                        <input class="seat" name="seats[]" value="DDB1"  type="checkbox">
                        <input class="seat" name="seats[]" value="DDB2"  type="checkbox">
                        <input class="seat" name="seats[]" value="DDB3"  type="checkbox">
                    </div>
                </div>
